...
struct CrashReportsView: View {
        ...
        ZStack {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: DS.Spacing.xl) {
                    ...
                    footnote(L.Stability.delayNote.localized)
                }
    ...
    private func versionSection() -> some View {
        card(L.Stability.byVersion.localized, note: L.Stability.byVersionNote.localized) {
            if versionRows.isEmpty {
                emptyRow(L.Stability.empty.localized)
            } else {
    ...
    private func recentSection() -> some View {
        card(L.Stability.recent.localized, note: nil) {
            if reports.isEmpty {
                emptyRow(L.Stability.empty.localized)
            } else {
